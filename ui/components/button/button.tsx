  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        royal:
          'bg-royal text-white hover:bg-royal-dark rounded-[10px] shadow-[0_1px_2px_rgba(13,30,75,0.15),0_4px_12px_rgba(13,30,75,0.12)]',
        'royal-outline':
          'bg-white text-royal border border-royal-border hover:bg-royal-pale rounded-[10px]',
        'royal-ghost':
          'bg-transparent text-royal hover:bg-royal-pale rounded-[10px]',
        dark: 'bg-ink-900 text-white hover:bg-ink-800 rounded-[10px]',
        mint: 'bg-mint-500 text-white hover:bg-mint-600 rounded-[10px] shadow-[0_1px_2px_rgba(20,63,46,0.15),0_4px_12px_rgba(20,63,46,0.10)]',
        'mint-outline':
